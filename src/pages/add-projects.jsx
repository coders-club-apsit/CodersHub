    ...
    try {
      ...
      if (broadcastNotification && notificationMessage.trim()) {
        await createNotification({
          ...
          message: notificationMessage.trim() || `New project added: ${data.title}`,
          priority: 'normal',
          target_audience: 'all'
        });
      }
    } catch (error) {
      console.error('Error creating project or notification:', error);
    }
  };
      ...
      <main className="container mx-auto px-24 py-8">
        ...
        <form onSubmit={handleSubmit(handleConfirmSubmit)} className="mx-auto space-y-6">
          ...
          <NotificationToggle
            ...
            defaultMessage={`New project added: ${watch("title")}`}
