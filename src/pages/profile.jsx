              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">Your saved notes will appear here</p>
                    <Button asChild>
                      <Link to="/saved-notes">View All Notes</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">Your saved resources will appear here</p>
                    <Button asChild>
                      <Link to="/saved-resources">View All Resources</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">Your saved projects will appear here</p>
                    <Button asChild>
                      <Link to="/saved-projects">View All Projects</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4">Your saved blogs will appear here</p>
                    <Button asChild>
                      <Link to="/saved-blogs">View All Blogs</Link>
                    </Button>
                  </div>
                </CardContent>
              </Card>
